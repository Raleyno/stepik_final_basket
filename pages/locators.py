...
class LoginPageLocators():
    ...
    MAIL = (By.CSS_SELECTOR, "input#id_registration-email")                 # email пользователя
    PASSW = (By.CSS_SELECTOR, "input#id_registration-password1")             # пароль пользователя
    PASSW2 =(By.CSS_SELECTOR, "input#id_registration-password2")            # повторить пароль
    SUBMIT_BTN = (By.CSS_SELECTOR, "button[name=registration_submit]")      # Кнопка "Зарегистрироваться"
